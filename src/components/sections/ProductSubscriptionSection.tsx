  ...
  return (
    ...
    >
      <Container maxWidth="xl" sx={{ px: { xs: 1, sm: 3, md: 4 } }}>
        <Grid container spacing={{ xs: 1.5, sm: 3, md: 4, lg: 6 }} alignItems="flex-start" sx={{ minHeight: '600px' }}>
          ...
          <Grid size={{ xs: 12, lg: 6 }}>
            ...
            >
              ...
              <MotionCard
                sx={{
                  borderRadius: { xs: '0.75rem', sm: '0.75rem', md: '1.5rem' },
                  overflow: 'hidden',
                  mb: 2,
                  boxShadow: '0 8px 32px rgba(0, 0, 0, 0.1)',
                  position: 'relative',
                  height: { 
                    xs: 'clamp(280px, 70vw, 320px)', 
                    sm: '400px', 
                    md: '420px', 
                    lg: '460px' 
                  },
                  ...
                  mt: { md: 12, lg: 14 },
                  mx: 'auto',
                  maxWidth: { xs: 'min(90vw, 340px)', sm: '100%' },
                  width: { xs: '100%', sm: '100%' },
                }}
              >
                <Box
          ...
          <Grid size={{ xs: 12, lg: 6 }}>
            <MotionBox
              ...
              sx={{ mt: { xs: 2, md: 4, lg: 6 }, px: { xs: 0.5, sm: 0 } }}
            >
              ...
              <Box sx={{ mb: 3, textAlign: 'center', position: 'relative' }}>
                <Typography
                  ...
                  sx={{
                    fontWeight: 700,
                    color: '#8B4513',
                    fontSize: { xs: 'clamp(1.4rem, 5vw, 1.8rem)', md: '2.2rem' },
                    mb: 1,
                  }}
                >
                  {t('choosePlan')}
                    ...
                    <CardContent sx={{ p: { xs: 1.5, sm: 3 } }}>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: { xs: 1.5, sm: 2 } }}>
                        ...
                        <Box sx={{ textAlign: 'right' }}>
                          ...
                          <Typography sx={{ fontSize: { xs: '0.8rem', sm: '0.9rem' }, color: '#666' }}>
                            {t('perMonthShort')}
                          </Typography>
                        </Box>
                      </Box>
              ...
              {/* Pricing Summary */}
              <Box sx={{ mt: { xs: 2, sm: 4 }, textAlign: 'center', p: { xs: 1.5, sm: 3 }, backgroundColor: '#F7F7F7', borderRadius: { xs: '0.5rem', sm: '1rem' }, mx: { xs: 0.25, sm: 0 }, maxWidth: { xs: 'calc(100vw - 24px)', sm: '100%' } }}>
                <Stack direction="row" alignItems="baseline" justifyContent="center" spacing={{ xs: 1, sm: 2 }} sx={{ mb: 2 }}>
                  ...
                  <Typography sx={{ fontSize: { xs: '0.9rem', sm: '1rem' }, color: '#666' }}>
                    NOK
                  </Typography>
                </Stack>
